...
const Tab_my_products = ({ tab_two, tab_one, tab_Five, tab_three }: Props) => {
            ...
            <View style={styles.ShopContainer}>
                <View style={styles.header}>
                    ...
                    <View style={{ flexDirection: 'row', alignItems: 'center', }}>
                        <TouchableOpacity onPress={onProductPress} activeOpacity={0.7}>
                            <Text style={styles.text}>Мои блюда</Text>
                        </TouchableOpacity>
                        {Tabs.map((e, i) => {
                            return (
                                <View
...
export default Tab_my_products;
